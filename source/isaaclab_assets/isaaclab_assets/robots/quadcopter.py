...
CRAZYFLIE_CFG = ArticulationCfg(
    ...
    spawn=sim_utils.UsdFileCfg(
        ...
        usd_path=os.path.join(os.path.dirname(__file__), "large_drone.usda"),
...
DRONE_WITH_PAYLOAD_CFG = ArticulationCfg(
    prim_path="{ENV_REGEX_NS}/Robot",
    spawn=sim_utils.UsdFileCfg(
        # usd_path=os.path.join(os.path.dirname(__file__), "drone_rope_payload.usda"),
...
"""Configuration for the quadcopter with a payload."""